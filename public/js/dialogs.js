...
try{
	angular.module('gettext'); // throws error if module not loaded
	// console.log('Dialogs (Angular-Translate): OK');
	 
	// dialogs.controllers: module declaration
	ctrlrs = angular.module('dialogs.controllers',['ui.bootstrap.modal','gettext']);
}catch(err){
 ...
 */
ctrlrs.controller('errorDialogCtrl', ['$scope', '$uibModalInstance', '$translate', 'data', function ($scope, $uibModalInstance, gettextCatalog, data) {
	//-- Variables -----//

    $scope.header = (angular.isDefined(data.header)) ? data.header : gettextCatalog.getString('DIALOGS_ERROR');
    $scope.msg = (angular.isDefined(data.msg)) ? data.msg : gettextCatalog.getString('DIALOGS_ERROR_MSG');
 ...
 */
ctrlrs.controller('waitDialogCtrl', ['$scope', '$uibModalInstance', 'gettextCatalog', '$timeout', 'data', function ($scope, $uibModalInstance, gettextCatalog, $timeout, data) {
	//-- Variables -----//

    $scope.header = (angular.isDefined(data.header)) ? data.header : gettextCatalog.getString('DIALOGS_PLEASE_WAIT_ELIPS');
    $scope.msg = (angular.isDefined(data.msg)) ? data.msg : gettextCatalog.getString('DIALOGS_PLEASE_WAIT_MSG');
 ...
 */
ctrlrs.controller('notifyDialogCtrl', ['$scope', '$uibModalInstance', 'gettextCatalog', 'data', function ($scope, $uibModalInstance, gettextCatalog, data) {
	//-- Variables -----//

    $scope.header = (angular.isDefined(data.header)) ? data.header : gettextCatalog.getString('DIALOGS_NOTIFICATION');
    $scope.msg = (angular.isDefined(data.msg)) ? data.msg : gettextCatalog.getString('DIALOGS_NOTIFICATION_MSG');
 ...
 */
ctrlrs.controller('confirmDialogCtrl', ['$scope', '$uibModalInstance', 'gettextCatalog', 'data', function ($scope, $uibModalInstance, gettextCatalog, data) {
	//-- Variables -----//

    $scope.header = (angular.isDefined(data.header)) ? data.header : gettextCatalog.getString('DIALOGS_CONFIRMATION');
    $scope.msg = (angular.isDefined(data.msg)) ? data.msg : gettextCatalog.getString('DIALOGS_CONFIRMATION_MSG');
 ...
 */
    ...
    angular.module('dialogs.main', ['dialogs.services', 'ngSanitize', 'ui.bootstrap']) // requires angular-sanitize.min.js (ngSanitize) //code.angularjs.org/1.2.1/angular-sanitize.min.js
	...
	.run(['$templateCache', '$interpolate', 'gettextCatalog', function ($templateCache, $interpolate, gettextCatalog) {
